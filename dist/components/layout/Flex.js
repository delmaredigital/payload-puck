...
export const FlexConfig = {
    ...
    render: ({ content: Content, semanticElement = 'div', direction, justifyContent, alignItems, gap, wrap, background, customPadding, margin, dimensions, border, animation, visibility, }) => {
        ...
        return (_jsxs(AnimatedWrapper, { animation: animation, children: [allMediaQueryCSS && _jsx("style", { children: allMediaQueryCSS }), _jsx(Wrapper, { className: wrapperClass, style: wrapperStyles, children: _jsx(Content, { className: contentClasses, style: contentStyles }) })] }));
    },
};
