...
export const ContainerConfig = {
    ...
    render: ({ content: Content, semanticElement = 'div', visibility, dimensions, background, border, padding, margin, animation, }) => {
        ...
        return (_jsxs(AnimatedWrapper, { animation: animation, children: [allMediaQueryCSS && _jsx("style", { children: allMediaQueryCSS }), hasStyles ? (_jsx(Wrapper, { className: containerClass, style: containerStyles, children: renderContent() })) : (_jsx(Content, { className: containerClass }))] }));
    },
};
