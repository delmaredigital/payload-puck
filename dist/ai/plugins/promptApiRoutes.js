    ...
    return {
        ...
        POST: async (request) => {
            try {
                ...
                return new Response(JSON.stringify({ error: 'Failed to create prompt' }), { status: 500, headers: { 'Content-Type': 'application/json' } });
            }
        },
    };
}
    ...
    return {
        ...
        DELETE: async (request, context) => {
            try {
                ...
                return new Response(JSON.stringify({ error: 'Failed to delete prompt' }), { status: 500, headers: { 'Content-Type': 'application/json' } });
            }
        },
    };
}
//# sourceMappingURL=promptApiRoutes.js.map