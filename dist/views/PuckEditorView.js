...
export async function PuckEditorView({ initPageResult, params, searchParams, }) {
    ...
    if (!pageId) {
        return (_jsx(DefaultTemplate, { i18n: req.i18n, locale: req.locale, params: params, payload: payload, permissions: initPageResult.permissions, searchParams: searchParams, user: req.user ?? undefined, visibleEntities: getVisibleEntities({ req }), children: _jsx("div", { style: {
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    height: '50vh',
                    color: 'var(--theme-elevation-500)',
                }, children: _jsx("p", { children: "No page ID provided. Please navigate from the collection view." }) }) }));
    }
    // Fetch the page data
    let page = null;
    let error = null;
    ...
    return (_jsx(DefaultTemplate, { i18n: req.i18n, locale: req.locale, params: params, payload: payload, permissions: initPageResult.permissions, searchParams: searchParams, user: req.user ?? undefined, visibleEntities: visibleEntities, children: error ? (_jsx("div", { style: {
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                height: '50vh',
                color: 'var(--theme-error-500)',
            }, children: _jsxs("p", { children: ["Error: ", error] }) })) : (_jsx("div", { style: {
