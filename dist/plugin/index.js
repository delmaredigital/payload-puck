...
function generatePuckEditField(collectionSlug, adminConfig = {}) {
    const { editorPathPattern = '/pages/{id}/edit', buttonLabel = 'Visual Editor', buttonPosition, // undefined = main area (default), 'sidebar' = sidebar
     } = adminConfig;
    return {
        name: 'puckEdit',
        type: 'ui',
...
export function createPuckPlugin(options = {}) {
    const { pagesCollection = 'pages', autoGenerateCollection = true, admin: pluginAdminConfig = {}, enableAdminView = true, adminViewPath = '/puck-editor', enableEndpoints = true, pageTreeIntegration, // No default - undefined means auto-detect
    editorStylesheet, editorStylesheetUrls = [], editorStylesheetCompiled, ai: aiConfig, } = options;
...
export { getPuckFields, puckDataField, editorVersionField, createEditorVersionField, pageLayoutField, createPageLayoutField, isHomepageField, seoFieldGroup, conversionFieldGroup, } from './fields';
