...
export function createContextListHandler() {
    return async (req) => {
        ...
        try {
            ...
            return Response.json({ error: e instanceof Error ? e.message : 'Failed to list context' }, { status: 500 });
        }
    };
}
/**
...
export function createContextCreateHandler() {
    return async (req) => {
        ...
        try {
            ...
            return Response.json({ error: e instanceof Error ? e.message : 'Failed to create context' }, { status: 500 });
        }
    };
}
/**
...
export function createContextUpdateHandler() {
    return async (req) => {
        ...
        try {
            ...
            return Response.json({ error: e instanceof Error ? e.message : 'Failed to update context' }, { status: 500 });
        }
    };
}
/**
...
export function createContextDeleteHandler() {
    return async (req) => {
        ...
        try {
            ...
            return Response.json({ error: e instanceof Error ? e.message : 'Failed to delete context' }, { status: 500 });
        }
    };
}
