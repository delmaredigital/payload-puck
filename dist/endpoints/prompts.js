...
export function createPromptsListHandler() {
    return async (req) => {
        ...
        try {
            ...
            return Response.json({ error: e instanceof Error ? e.message : 'Failed to list prompts' }, { status: 500 });
        }
    };
}
/**
...
export function createPromptsCreateHandler() {
    return async (req) => {
        ...
        try {
            ...
            return Response.json({ error: e instanceof Error ? e.message : 'Failed to create prompt' }, { status: 500 });
        }
    };
}
/**
...
export function createPromptsUpdateHandler() {
    return async (req) => {
        ...
        try {
            ...
            return Response.json({ error: e instanceof Error ? e.message : 'Failed to update prompt' }, { status: 500 });
        }
    };
}
/**
...
export function createPromptsDeleteHandler() {
    return async (req) => {
        ...
        try {
            ...
            return Response.json({ error: e instanceof Error ? e.message : 'Failed to delete prompt' }, { status: 500 });
        }
    };
}
